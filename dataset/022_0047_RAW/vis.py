...
# ==========================================
# MONKEY PATCH (Fixes "ModuleNotFoundError")
# ==========================================
# This tricks Python into thinking 'exifread' exists so pickle doesn't crash.
from types import ModuleType
import sys

fake_classes = ModuleType("exifread.classes")
sys.modules["exifread.classes"] = fake_classes

class IfdTag:
    def __init__(self, *args, **kwargs): pass
    def __repr__(self): return "ExifData(Ignored)"

fake_classes.IfdTag = IfdTag


if __name__ == '__main__':
    base_path = 'C:\\Users\\lozan\\Documents\\Education\\MambaFusion\\data\\022_0047_RAW'
    img_name = '022_MFSR_Sony_0047_x4_rgb'
    pkl_name = 'MFSR_Sony_0047_x4'
    img_path = '{}/{}.png'.format(base_path, img_name)
    pkl_path = '{}/{}.pkl'.format(base_path, pkl_name)
    ...
    vis = generate_processed_image_channel3(img, meta_data, return_np=True)

    vis = cv2.cvtColor(vis, cv2.COLOR_RGB2BGR)

    cv2.imwrite('{}/{}_vis_x4.png'.format(base_path, img_name), vis)