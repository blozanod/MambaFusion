...
from burstISP.archs.vgg_arch import VGGFeatureExtractor
from burstISP.utils.registry import LOSS_REGISTRY
...
class GWLoss(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        weight_x = self.base_weight_x.repeat(c, 1, 1, 1).type_as(x1)
        weight_y = self.base_weight_y.repeat(c, 1, 1, 1).type_as(x1)
